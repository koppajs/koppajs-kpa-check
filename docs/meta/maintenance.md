...
| New build, lint, test, or release flow | `CONTRIBUTING.md`, `TESTING_STRATEGY.md`, `docs/quality/quality-gates.md`, `docs/meta/tooling-baseline.md`, `RELEASE.md` |
...
5. Record new structural decisions as ADRs.
6. Add roadmap items for known gaps that are not fixed immediately.
